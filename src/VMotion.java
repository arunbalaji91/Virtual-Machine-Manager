...
public class VMotion extends ConnectedVimServiceBase {
    ...
    */
    ...
    void migrateVM(String vmname, String pool, String tHost,
                   String srcHost, String priority) throws RuntimeFaultFaultMsg, InvalidPropertyFaultMsg, VmConfigFaultFaultMsg, InsufficientResourcesFaultFaultMsg, FileFaultFaultMsg, MigrationFaultFaultMsg, InvalidStateFaultMsg, TimedoutFaultMsg, InvalidCollectorVersionFaultMsg, IOException {
    ...
    */
    ...
    void migrateOrRelocateVM() throws RuntimeFaultFaultMsg, InvalidPropertyFaultMsg, InsufficientResourcesFaultFaultMsg, VmConfigFaultFaultMsg, FileFaultFaultMsg, InvalidStateFaultMsg, MigrationFaultFaultMsg, InvalidCollectorVersionFaultMsg, TimedoutFaultMsg, InvalidDatastoreFaultMsg, IOException {
    ...
    @Action
    public void run() throws RuntimeFaultFaultMsg, VmConfigFaultFaultMsg, InsufficientResourcesFaultFaultMsg, InvalidDatastoreFaultMsg, InvalidPropertyFaultMsg, FileFaultFaultMsg, MigrationFaultFaultMsg, InvalidStateFaultMsg, InvalidCollectorVersionFaultMsg, TimedoutFaultMsg, IOException {
        if (customValidation()) {
    ...
    @Action
    public void run(com.vmware.vim25.ServiceContent serviceContent, com.vmware.vim25.VimPortType vimPort) throws RuntimeFaultFaultMsg, VmConfigFaultFaultMsg, InsufficientResourcesFaultFaultMsg, InvalidDatastoreFaultMsg, InvalidPropertyFaultMsg, FileFaultFaultMsg, MigrationFaultFaultMsg, InvalidStateFaultMsg, InvalidCollectorVersionFaultMsg, TimedoutFaultMsg, IOException {
        if (customValidation()) {
        	
        	this.vimPort = vimPort;
        	this.targetHost = "128.230.96.40";
        	this.sourceHost = "128.230.96.111";
        	this.targetPool = "apandey";
        	this.targetDS = "Storm_store1";
        	this.vmName = "ArunVM1";
        	this.priority = "high_Priority";
        	this.state = "powered_On";
     
        	this.serviceContent = serviceContent;
            propCollectorRef = this.serviceContent.getPropertyCollector();
            migrateOrRelocateVM();
        }
    }
